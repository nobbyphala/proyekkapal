...
public class PenjadwalanAdapter extends ArrayAdapter<penjadwalan> {
    public PenjadwalanAdapter(Context context, int resource, List<penjadwalan> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentTambah=new Intent(v.getContext(),PenjadwalanProyekEdit.class);
