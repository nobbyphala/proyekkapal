...
public class ProgresProyek extends AppCompatActivity {
    ...
    public void openIntent(String nama){
        ...
        bundle.putString("namaprogres", nama);
        Intent intent=new Intent(getBaseContext(),ProgresProyekDetail.class);
    ...
    void openSearch(){
        ...
        cari.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                editor.putString("menu", "progress");
                editor.commit();
