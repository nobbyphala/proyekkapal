...
public class SdmSubcontractorAreapekerjaan extends AppCompatActivity {
    private Button tambah;
    private String id_subcontractor, username_user, password_user, kategori_user;
    private TextView namapt;
    private Bundle bundle;
    public final String URL_GET="http://188.166.240.88:8000/kapal/listareapekerjaan/";
    public final String URL_POST="http://188.166.240.88:8000/kapal/areapekerjaan/";
    private ProgressDialog loading;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sdmproyek_subcontractor_areapekerjaan);
        tambah=(Button) findViewById(R.id.tambah_subcontractor_areapekerjaan);
        namapt=(TextView) findViewById(R.id.namapt_subcontractor_areapekerjaan);

        bundle = getIntent().getExtras();
        String name = bundle.getString("nama");
        id_subcontractor=bundle.getString("id");

        namapt.setText("Area Pekerjaan "+name + " :");
...
//        }
    ...
    View.OnClickListener operasi=new View.OnClickListener(){
        ...
        public void onClick(View view){
            switch (view.getId()){
                case R.id.tambah_subcontractor_areapekerjaan:
                    openTambah();break;
            }
        }
    };
    ...
    private void showdata(String json){
        loading.dismiss();
        AmbilSubcontractorAreaPekerjaan ambilSubcontractorAreaPekerjaan=new AmbilSubcontractorAreaPekerjaan(json);
        ArrayList<subcontractorareapekerjaan> list=new ArrayList<subcontractorareapekerjaan>();
        ListView listView=(ListView) findViewById(R.id.list_subcontractor_areapekerjaan);
        SubcontractorAreaPekerjaanAdapter subcontractorAreaPekerjaanAdapter=new SubcontractorAreaPekerjaanAdapter(this,0,list);
        ambilSubcontractorAreaPekerjaan.ambilsubcontractorareapekerjaan(subcontractorAreaPekerjaanAdapter);
        listView.setAdapter(subcontractorAreaPekerjaanAdapter);
    }
    ...
    public void openTambah(){
        ...
        View input = li.inflate(R.layout.sdmproyek_subcontractor_areapekerjaan_tambah,null);
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        Button tambahareapekerjaan=(Button)input.findViewById(R.id.tambah_subcontractor_areapekerjaan_tambah);
        final EditText namaareapekerjaan=(EditText)input.findViewById(R.id.pekerjaan_subcontractor_areapekerjaan_tambah);
        tambahareapekerjaan.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                String nama=namaareapekerjaan.getText().toString();
                insert(nama);
            }
        });
    ...
    public void insert(final String pekerjaan){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_POST,
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("password",password_user);
                params.put("id_subcontractor",id_subcontractor);
                params.put("detail_pekerjaan",pekerjaan);
                return params;
            }
    ...
    public void openUlang() {
        Intent intentTambah = new Intent(getBaseContext(), SdmSubcontractorAreapekerjaan.class);
